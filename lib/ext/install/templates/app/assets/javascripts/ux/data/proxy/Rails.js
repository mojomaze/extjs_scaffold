 ...
 * For example: 
 *   POST /teams/delete_all.json (used on a collection)
 *   POST /teams/1/send_note.json (used on a member)
 */
Ext.define('App.ux.data.proxy.Rails', {
    extend: 'Ext.data.proxy.Rest',
    alias : 'proxy.rails',
	
	/**
	* Config object of allowed actions
	* 
	* addActions: {
	*	destroy_all: {
	*		method: 'POST',
	...
	*/
	...
	/**
     * Overrides buildUrl - incorporates the {@link #appendId} and {@link #format} options from Rest proxy
